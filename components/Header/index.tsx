...
const Header = () => {
  ...
  return (
    <>
  <header
        className={`header top-0 left-0 z-40 flex w-full align-center bg-transparent ${
          sticky
      ...
      >
        <div className="container flex items-center">
          {/* Logo Section - Set height and overflow */}
          <div className="w-60 max-w-full px-4 xl:mr-8 flex-none hidden md:block " style={{ height: '100px', overflow: 'hidden' }}>
  <Link href="/">
    <Image
  ...
  className="absolute right-4 top-1/2 block translate-y-[-50%] rounded-lg px-3 py-[0px] ring-primary focus:ring-2 lg:hidden pt-4"
>
  <span
