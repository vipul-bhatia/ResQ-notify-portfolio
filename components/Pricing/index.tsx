    ...
    <section id="pricing" className="relative z-10 py-16 md:py-20 lg:py-28">
      <div className="container">
        <SectionTitle
          ...
          paragraph="Choose from our flexible pricing options tailored to meet your hardware integration and safety needs with ReqNotify. Empower your fleet with our budget-friendly plans."
          center
          width="665px"
        />
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-2 lg:grid-cols-3">
          ...
          >
            ...
            <OfferList text="Driver Analysis (Limited)" status="active" />
            <OfferList text="Emergency Contacts (Limited)" status="active" />
          ...
          >
            ...
            <OfferList text="Driver Analysis (Unlimited)" status="active" />
            <OfferList text="Emergency Contacts (Unlimited)" status="active" />
            <OfferList text="Mobile App Access" status="active" />
          </PricingBox>
          <PricingBox
          ...
          >
            ...
            <OfferList text="Advanced Driver Analysis (Unlimited)" status="active" />
            <OfferList text="Emergency Contacts (Unlimited)" status="active" />
            <OfferList text="Mobile App Access" status="active" />
          </PricingBox>
        </div>
